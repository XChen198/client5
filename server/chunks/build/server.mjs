...
const _routes = [
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-DOmUs2VP.mjs').then((m) => m.default || m)
  },
  {
    name: "login",
    path: "/login",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./_id_-RIn6Qn7x.mjs').then((m) => m.default || m)
  },
  {
    name: "signup",
    path: "/signup",
